...
async def help(ctx):
    ...
    embed.add_field(name="Alap Parancsok:", value="sinfo, shelp, sbroadcast <Üzenet>, sclear <mennyiség>", inline=False)
    embed.add_field(name="Fun Parancsok:", value="Hamarosan", inline=False)
    embed.add_field(name="Zene Parancsok:", value="Hamarosan", inline=False)
    embed.add_field(name="Moderációs Parancsok:", value="sban, skick, sunmute, smute", inline=False)
    embed.set_footer(text="𝐒𝐜𝐫𝐚𝐩𝐩𝐲 | 𝟏.𝟎")
...
client.run("NjkwNjI3MTQyMzc1MTc4MzQx.XnXJwA.TJqJY02NUUYkN2TsKM9_ASPK7ak")
